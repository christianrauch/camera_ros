...
// - "ExposureTimeMode" is set to auto if "AeEnable" is true
// - "ExposureTimeMode" is set to manual if "AeEnable" is false
// - "ExposureTimeMode" take precedence over "AeEnable"
